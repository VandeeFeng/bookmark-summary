...
date: 2025-04-22
extra:
  source: https://guangzhengli.com/blog/zh/indie-hacker-tech-stack-2024
  original_title: 独立开发技术栈 2025
---
## Summary
**摘要**：
...
URL Source: https://guangzhengli.com/blog/zh/indie-hacker-tech-stack-2024
...
说完了前端库和平台的选择，我们来到后端的领域，其实纯后端的选择反而不多。因为后端想要提供服务，离不开 CPU、内存、带宽等资源，而这些资源各大花销都不少，所以我更多推荐 Serverless 的方案。如果你想要熟悉的后端框架，也可以使用 [Railway](https://railway.com/?referralCode=SDfuE1)、[Fly.io](https://fly.io/) 等平台来部署容器。
...
推荐使用容器部署的方案，而不是自己管理主机部署，关于容器部署的平台，推荐 [Railway](https://railway.com/?referralCode=SDfuE1) 和 [Fly.io](https://fly.io/)，这两个平台都是容器部署和管理比较丝滑的平台，除了部署后端外，也可以部署数据库等服务。推荐理由是这两个平台因为个人开源活跃度还算高的原因，都送了我每月 $5 的免费额度，而且用完后确实感觉还不错。
...
![Image 1: t4-stack](https://storage.guangzhengli.com/images/t4-stack.png)
...
*   [https://nextra.site/docs/guide/ssg](https://nextra.site/docs/guide/ssg)
*   [https://developers.cloudflare.com/pages/framework-guides/nextjs/deploy-a-nextjs-site/](https://developers.cloudflare.com/pages/framework-guides/nextjs/deploy-a-nextjs-site/)
...
*   [https://developers.cloudflare.com/workers/platform/pricing/#workers](https://developers.cloudflare.com/workers/platform/pricing/#workers)
*   [https://next-auth.js.org/](https://next-auth.js.org/)
*   [https://blog.cloudflare.com/prisma-orm-and-d1](https://blog.cloudflare.com/prisma-orm-and-d1)
*   [https://www.cloudflare.com/zh-cn/products/distributed-sql-database/](https://www.cloudflare.com/zh-cn/products/distributed-sql-database/)
