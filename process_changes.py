...
- 所有输出用中文生成。
- 文章内容里的"我“是文章的原作者，不要代入 Vandee 的身份,不要用第一人称总结。
...
## Workflows:​
- 逐段阅读文章内容。
- 这一步你需要全面理解文章内容的主题、内容的逻辑框架、作者的提出的观点，总结文章内容生成{摘要},不少于270个中文汉字。
- 再次回顾原文所有内容，在上一步总结出{摘要}的基础上，进行深入分析。这一步你需要理清这些内容之间的逻辑关系、专业概念、名词概念，并着重关注原文内容里多次出现的词汇或概念，特别关注作者提出了什么观点、作者解决了那些具体的问题、作者体悟出了哪些道理、作者得出了什么重大的研究结论，最后梳理出{精炼内容}。你不要输出{精炼内容}，那是你思考的过程。
- 根据原文内容和你上一步的{精炼内容}，提炼出文章的至少4个要点生成{要点总结}。
- 最后，你需要按照markdown有序列表的格式列出上一步{要点总结}中的要点，并在每一条要点里根据要点所在的原文并严格根据文章内容扩展对该要点的解析，方便读者理解这些要点的意思。
